				...
				<div class="page-content">		
					...
					<div class="wizard-actions-L">
						<button type="button" class="btn btn-sm btn-white btn-bold" 
							onclick="OpenWindow('<%=request.getContextPath()%>/board/regist','','850','620');">
					...
					<div class="row">
						<div class="col-xs-12">
							<div id="grid_container">
								...
								<div class="loading ui-state-default ui-state-active" id="load_grid-table" style="display: none;"> Data Loading...</div>
											...
											<div></div>
												<table id="grid-table" tabindex="0" role="presentation" aria-multiselectable="false" aria-labelledby="gbox_grid-table" class="ui-jqgrid-btable ui-common-table">
														...
														<tr role="row" class="jqgrow ui-row-ltr ui-widget-content">																													
															<td role="gridcell" style="text-align:center;" aria-describedby="grid-table_apprNowUser" >${pds.pno }</td>
															<td role="gridcell" >
																<a href="#" data-target="${pds.pno }" onclick="detail_pds_go(${pds.pno});" share-data="<c:forEach var="pdsShare" items="${pds.pdsShareList }">${pdsShare.identity }:</c:forEach>"
																   style='<c:if test="${notice.viewcnt >= 5}" >font-weight:bold;color:blue;</c:if>'>${pds.title } 
															...
															<td role="gridcell" style="text-align:center;" >
																<a class="maninfo" rel="${pds.writer }" href="#" data-hasqtip="21">
															...
															<td role="gridcell" style="text-align:center;" >${pds.viewcnt }</td>
														</tr>
														</c:forEach>
...
<%@ include file="/WEB-INF/views/board/pds/pds_list_js.jsp" %>
