			...
			<ul class="nav ace-nav">
				...
				<li class="blue" id="people-info">
					<a data-toggle="dropdown" href="#" class="dropdown-toggle"> 
						<img class="nav-user-photo" src="<%=request.getContextPath() %>/employee/picture/${loginUser.id}" onerror="this.src='<%=request.getContextPath() %>/resources/common/libs/garam-admin-template/1.3.5/avatars/avatar4.png'" width="36" height="36" />
